	...
	$.getJSON("/getBar", {"t":timestamp}, function (json) {
		...
		if (bytesRead == contentLength) {
			...
			if (contentLengthGtMB == 0) {
				...
				$("div#info").html("\u4e0a\u4f20\u5b8c\u6210\uff01\u603b\u5171\u5927\u5c0f" + contentLengthToShow + "MB.\u5b8c\u6210100%"+"<br/><font color='green'>正在把数据保存到数据库............</font>");
		    //如要在上传完成后接着要保存其它数据，要提交相关表单 document.getElementById("form1").submit();
